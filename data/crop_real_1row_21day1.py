...
input_folder = "data/data_backup/real_data_dicom/21dias_bandeja1/images"
output_folder = "data/data_backup/real_data_dicom/21dias_bandeja1/images-crop"
...
y_positions = [[27, 115],
               [119, 208],
               [206, 298],#cortei 1 a mais de 177 -> 178
               [298, 388],#cortei 1 a mais de 251 -> 252
               [388, 478]]#cortei 1 a mais de 399 -> 400
...
input_folder_masks = "data/data_backup/real_data_dicom/21dias_bandeja1/masks"
output_folder_masks = "data/data_backup/real_data_dicom/21dias_bandeja1/masks-crop"
    ...
    if idx==4:
        for i in range(0,5):
            if i == 0:
                ...
                y_aux[i][0] = y_aux[i][0]+3
                y_aux[i][1] = y_aux[i][1]+4
                # y_aux[i] = [x - 1 for x in y_aux[i]]
            elif i ==2:
                y_aux[i] = [x + 4 for x in y_aux[i]]
            elif i ==3:
    ...
    if idx==5:
        for i in range(0,5):
            if i == 0:
                ...
                y_aux[i][0] = y_aux[i][0] +2
                y_aux[i][1] = y_aux[i][1] +3
                # y_aux[i] = [x - 1 for x in y_aux[i]]
            elif i ==2:
                y_aux[i] = [x + 1 for x in y_aux[i]]
            elif i ==3:
                y_aux[i] = [x + 5 for x in y_aux[i]]
            elif i ==4:
                y_aux[i] = [x + 6 for x in y_aux[i]]
                y_aux[i][0] = y_aux[i][0]+2
