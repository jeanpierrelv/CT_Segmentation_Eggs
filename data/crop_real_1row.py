...
##---------------------------------------------------------------------------##
    ...
    if len(sorted_files) < min_depth:
        ...
        dicom_file = sorted_files[start_slice:end_slice][0]
        ...
        for j in range(1, miss_slices_back+1):
            name_file_back = sorted_files[start_slice:end_slice][-1].split('.')
...
input_folder = "data/data_backup/real_data_dicom/7dias_bandeja1/images"
output_folder = "data/data_backup/real_data_dicom/7dias_bandeja1/images-crop"
...
input_folder_masks = "data/data_backup/real_data_dicom/7dias_bandeja1/masks"
output_folder_masks = "data/data_backup/real_data_dicom/7dias_bandeja1/masks-crop"
...
for idx, aux in enumerate(folders_list_slices):
    ...
    if idx >= 2: # after 3th row (fileira)
        for i in range(2,6):
            if i <= 4:
